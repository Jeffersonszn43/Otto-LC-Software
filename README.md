...
7. Now, you should be setup to start working on the skeleton program to work with your robots. Go to the `Otto_LC_Software` folder and download the `Otto_LC.py` program and bring the file to the file explorer of the Pico using the same method used for bringing the files of the Otto MicroPython library over from your local computer to the Raspberry Pi Pico H.    
